...
namespace _03_JSON
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            #region Sin constructor por defecto y no pública
            ...
            Dato4 aux2 = (Dato4)System.Text.Json.JsonSerializer.Deserialize<Dato4>(obj_json);

            Console.WriteLine(aux2.Mostrar());
            ...
            Console.WriteLine(obj5.Mostrar());

            #endregion

            #region Con archivos

            using (System.IO.StreamWriter sw = new System.IO.StreamWriter(@"C:\hola\dato.json"))
            {
                sw.WriteLine(obj_json);
            }

            Dato4 obj_archivo;
            using (System.IO.StreamReader sr = new System.IO.StreamReader(@"C:\hola\dato.json"))
            {
            ...
            Console.WriteLine(obj_archivo.Mostrar());
